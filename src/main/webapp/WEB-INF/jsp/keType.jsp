    ...
    <form id="myForm" method="post">
        ...
        <table>
            <tr>
                <td>课程类型</td>
                <td>
                    <input class="easyui-textbox" name="kename">
                </td>
            </tr>
            <tr>
                <td>对应课程</td>
...
<script>
    ...
    function add(){
        $("#myForm").form("submit",{
            url:"<%=request.getContextPath() %>/addkeType",
            success:function(){
    ...
    //查询
    $("#myTable").datagrid({
        url:"<%=request.getContextPath()%>/queryType",
        columns:[[
            {field:'check',checkbox:true},
            {field:'id',title:'编号',width:100,align:'center'},
            {field:'kename',title:'课程类型',width:100,align:'center'},
