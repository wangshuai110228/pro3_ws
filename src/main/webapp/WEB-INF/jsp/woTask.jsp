...
<script>
    ...
    $("#myTablek").datagrid({
        url:"<%=request.getContextPath()%>/querywoTask",
        columns:[[
            ...
            {field:'rtype',title:'是否完成',width:100,align:'center',formatter:function(value,row,index){
                    if(value==1){
                        return "完成";
                    }else{
                        return "未完成";
            ...
            {field:'tools',title:'操作', width:100,align:'center',formatter:function(value,row,index){
                    var str = "<a href='javascript:openUpdateTask("+row.id+")'>已完成任务</a>"
                    return str;
                }}
